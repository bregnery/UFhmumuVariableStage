...
vhmumuHist = vhmumu.Get("Zeppenfeld2Hist")
vhmumuHist.SetName("vHmumu")
ttHist = tt.Get("Zeppenfeld2Hist")
ttHist.SetName("TT")

vbfHist = vbf.Get("Zeppenfeld2Hist")
gghHist = ggH.Get("Zeppenfeld2Hist")
dyHist = dy.Get("Zeppenfeld2Hist")
tthHist = ttH.Get("Zeppenfeld2Hist")
...
axisHist = root.TH2F("axisHist","Zeppenfeld 2",1,xMin,xMax,1,yMin,yMax)
...
canvas.SaveAs("Hist_Zeppenfeld2.png")
